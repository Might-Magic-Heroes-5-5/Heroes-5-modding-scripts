...
Speed = #{speed_flat} + #{speed_sp}*SP + #{speed_lvl}*HERO_LVL"
	...
	('0.979'), ('0.982'), ('0.985'), ('0.988'), ('0.991'), ('0.993'), ('0.995'), ('0.997'), ('0.998'), ('0.999'), ('1');"
		...
		db.execute "UPDATE micro_artifact_effect SET effect='0.15' WHERE id='MAE_PIERCING';"
		db.execute "UPDATE micro_artifact_effect SET effect='0.1' WHERE id='MAE_ARMOR_CRUSHING';"
		db.execute "UPDATE micro_artifact_effect SET effect='0.167' WHERE id='MAE_HEALTH';"
		db.execute "UPDATE micro_artifact_effect SET effect='0.15' WHERE id='MAE_DEFENCE';"
		db.execute "UPDATE micro_artifact_effect SET effect='40' WHERE id='MAE_MAGIC_PROTECTION';"
		db.execute "UPDATE micro_artifact_effect SET effect='0.05' WHERE id='MAE_LUCK';"
		db.execute "UPDATE micro_artifact_effect SET effect='0.05' WHERE id='MAE_MORALE';"
		db.execute "UPDATE micro_artifact_effect SET effect='0.025' WHERE id='MAE_SPEED';"
		db.execute "UPDATE micro_artifact_effect SET effect='0.5' WHERE id='MAE_HASTE';"
	end
